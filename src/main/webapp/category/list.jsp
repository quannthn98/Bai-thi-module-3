                    ...
                    <table class="table table-striped">
                        ...
                        <c:forEach items="${categoryList}" var="category">
                            <tr>
                                <td>${category.id}</td>
                                <td>${category.name}</td>
                                <td> <button type="button" class="btn btn-primary btn-sm" ><a style="color: white" href="/category?action=edit&id=${category.id}">Edit</a></button>
                                    <button type="button" class="btn btn-danger btn-sm"><a style="color: white;" href="/category?action=delete&id=${category.id}">Delete</a></button></td>
                            </tr>
                        </c:forEach>
                    </table>
                </div>
