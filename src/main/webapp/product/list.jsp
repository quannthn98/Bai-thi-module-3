                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <form>
                                <div class="row">
                                    <div class="col">
                                        <input class="form-control" style="size: 200px" type="text" placeholder="Search" aria-label="Search" name="q">
                                    </div>
                                    <div class="col">
                    ...
                    <table class="table table-striped">
                        ...
                        <c:forEach items="${productList}" var="product">
                            <tr>
                                ...
                                <td> <button type="button" class="btn btn-primary btn-sm" ><a style="color: white" href="/product?action=edit&id=${product.id}">Edit</a></button>
                                    <button type="button" class="btn btn-danger btn-sm"><a style="color: white;" href="/product?action=delete&id=${product.id}">Delete</a></button></td>
                            </tr>
                        </c:forEach>
                    </table>
                </div>
